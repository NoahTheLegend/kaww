...
void onTick(CSprite@ this)
{
    ...
    bool no_swing = blob.get_bool("no_swing");//Nu changed area.

	bool knocked = isKnocked(blob);
	const bool action2 = blob.isKeyPressed(key_action2) && !no_swing;//Nu changed area NuMenu.
	const bool action1 = blob.isKeyPressed(key_action1) && !no_swing;//Nu ETC

    if(no_swing) { blob.set_bool("no_swing", false); }//Nu
