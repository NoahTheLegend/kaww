...
void SetItemDescription_Tech(CGridButton@ button, CBlob@ caller, CBitStream &in reqs, const string& in description, CInventory@ anotherInventory = null, bool always_disable = false)
{
