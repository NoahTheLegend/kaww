...
const int input = 30;					//input cost in fuel
...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	if (!caller.hasBlob("mat_stone", 1)) return;

	CBitStream params;
	params.write_u16(caller.getNetworkID());

	CButton@ button = caller.CreateGenericButton("$mat_stone$", Vec2f(1.0f, 3.0f), this, this.getCommandID("add stone"), getTranslatedString("Smelt stone"), params);
	if (button !is null)
	{
