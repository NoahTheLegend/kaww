...
void onInit(CBlob@ this)
{
	...
	{ CSpriteLayer@ w = Vehicle_addPokeyWheel(this, v, 0, Vec2f(27.0f,   1.0f)); if (w !is null) w.SetRelativeZ(20.0f); w.ScaleBy(Vec2f(0.75f,0.75f));}
	...
	{ CSpriteLayer@ w = Vehicle_addRollerWheel(this, v, 0, Vec2f(-12.0f, 4.75f)); if (w !is null) w.SetRelativeZ(10.0f); }
	{ CSpriteLayer@ w = Vehicle_addRollerWheel(this, v, 0, Vec2f(-20.0f, 4.75f)); if (w !is null) w.SetRelativeZ(10.0f); }
	{ CSpriteLayer@ w = Vehicle_addRollerWheel(this, v, 0, Vec2f(-28.0f, 1.5f)); if (w !is null) {w.SetRelativeZ(20.0f); w.ScaleBy(Vec2f(0.8f,0.8f));}}
	...
	if (tracks !is null)
	{
		...
		tracks.SetOffset(Vec2f(-2.0f, 0.0f));
	}

	// attach turret & machine gun
	if (getNet().isServer())
	{
		CBlob@ turret = server_CreateBlob("bc25turret");	
