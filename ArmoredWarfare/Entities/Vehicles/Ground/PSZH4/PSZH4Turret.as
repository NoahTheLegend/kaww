...
void Vehicle_onFire(CBlob@ this, VehicleInfo@ v, CBlob@ bullet, const u8 _charge)
{
	...
	if (bullet !is null)
	{
		...
		Vec2f pos = this.getPosition() + (this.isFacingLeft()?Vec2f(-4.0f,0):Vec2f(4.0f,0)) + Vec2f((this.isFacingLeft() ? -1 : 1)*26.0f, -12.0f).RotateBy((this.isFacingLeft()?angle+90:angle-90));
