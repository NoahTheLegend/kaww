...
class M60Turret : TurretStats
{
    M60Turret()
    {
        ...
        cooldown_time = 210; high_angle = 70; low_angle = 105;
...
class ArtilleryTurret : TurretStats
{
    ArtilleryTurret()
    {
        ...
        cooldown_time = 25*30; high_angle = 15; low_angle = 70; projectile_vel = -40.0f;
        arm_offset = Vec2f(-8.0f, -33.0f); arm_z = -50.0f; barrel_compression = 24; init_gun_angle = -30;
        recoil_force = 900; fire_sound = "sound_128mm"; muzzle_offset = -32; arm_height = -2.0f; arm_joint_offset = Vec2f(-0.5f, 26.0f);
...
class GradTurret : TurretStats
{
    GradTurret()
    {
        ...
        // muzzle_offset = -32; arm_height = -2.0f; arm_joint_offset = Vec2f(-0.5f, 26.0f);
    }
};
...
class BC25Turret : TurretStats
{
    BC25Turret()
    {
        ...
        cassette_size = 5; cycle_cooldown = 60; ammo_quantity = 24; muzzle_offset = -32.0f;
