...
class Pak38Turret : TurretStats
{
    Pak38Turret()
    {
        ...
        cooldown_time = 120; high_angle = 80; low_angle = 95;
        arm_z = -5.0f; barrel_compression = 6; init_gun_angle = 5;
...
class ArtilleryTurret : TurretStats
{
    ArtilleryTurret()
    {
        ...
        cooldown_time = 2*30; high_angle = 15; low_angle = 80; projectile_vel = -47.5f;
...
class M40Turret : TurretStats
{
    M40Turret()
    {
        ...
        cooldown_time = 2*30; high_angle = 15; low_angle = 90; projectile_vel = -42.5f;
...
class GradTurret : TurretStats
{
    GradTurret()
    {
        ...
        cooldown_time = 6*30; high_angle = 45; low_angle = 90; projectile_vel = -39.0f;
