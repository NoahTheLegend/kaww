...
//	this.addCommandID("detach"); in StandardControls
	...
	if (menu.entries.length == 0)
	{
		...
		menu.add_entry(PickupWheelMenuEntry("Tank Ammo", "$mat_105mmround$", "mat_bolts"));
...
f32 getPriorityPickupScale(CBlob@ this, CBlob@ b)
{
	...
	// //builders
	// const bool builder = (thisname == "mechanic");
	...
	else if ((name == "molotov" || name == "molotov_us" || name == "molotov_nazi" || name == "agrenade" 
    || name == "sgrenade" || name == "grenade" || name == "atgrenade" || name == "mat_atgrenade"
