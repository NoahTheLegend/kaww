...
namespace Material
{
	...
	void fromTile(CBlob@ this, uint16 &in type, float &in damage)
	{
        ...
        if (alliance_power && XORRandom(5)==0) extra_amount = 2.0f;

		if (map.isTileThickStone(type))
		{
			createFor(this, 'mat_stone', (6.f+extra_amount) * damage);
            
		}
		else if (map.isTileStone(type))
		{
			createFor(this, 'mat_stone', (4.f+extra_amount) * damage);
		}
		...
		{
			createFor(this, 'mat_gold', (4.f+extra_amount) * damage);
		}
	}
}
