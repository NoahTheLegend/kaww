...
namespace map_colors
{
	enum color
	{
		...
		//only defense
		b_vehiclebuilderdefense       		= 0xff3eff47,
		r_vehiclebuilderdefense       		= 0xff47ff39,
		b_vehiclebuildert2defense     		= 0xff3eff48,
		r_vehiclebuildert2defense     		= 0xff47ff3a,

		b_vehiclebuilderdefenseconst      	= 0xff3eff4f,
		r_vehiclebuilderdefenseconst      	= 0xff47ff3f,
