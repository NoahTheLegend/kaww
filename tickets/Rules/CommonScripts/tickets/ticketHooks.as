...
void onRender(CRules@ this){
	...
	GUI::DrawText( ""+redTickets, Vec2f(230,getScreenHeight()-100), getTeamColor(1) );		//shows tickets just above bottom left HUD
	GUI::DrawText( ""+blueTickets, Vec2f(180,getScreenHeight()-100), getTeamColor(0) );
