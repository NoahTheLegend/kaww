...
{
	if(this.get_string("reload_script") != "goldenhelmet")
		UpdateScript(this);
}

void UpdateScript(CBlob@ this)
{
    CSpriteLayer@ helmet = this.getSprite().addSpriteLayer("goldenhelmet", "GoldenHelmet.png", 16, 16);
...
void onTick(CBlob@ this)
{
    ...
    CSpriteLayer@ helmet = this.getSprite().getSpriteLayer("goldenhelmet");
