	...
	if (this.hasAttached() || this.getTickSinceCreated() < 30)
	{
		...
		if (gunner !is null && gunner.getOccupied() !is null && !broken)
		{
			...
			if (p !is null)
			{
				...
				{
					high_angle = 76.5f; // upper depression limit
...
void Vehicle_onFire(CBlob@ this, VehicleInfo@ v, CBlob@ bullet, const u8 _charge)
{
	...
	if (bullet !is null)
	{
		...
		Vec2f pos = bullet.getPosition() + Vec2f((this.isFacingLeft() ? -1 : 1)*64.0f, 4.0f).RotateBy((this.isFacingLeft()?angle+90:angle-90));
