...
void onInit(CBlob@ this)
{
	...
	CSpriteLayer@ launcher = sprite.addSpriteLayer("launcher", "UHT_Launcher", 16, 16);
	...
	if (launcher !is null)
	{
		...
		if (launcher !is null)
		{
			launcher.SetRelativeZ(5.5f);
			launcher.SetOffset(Vec2f(8.0f, -17.0f));
		}
	}
	...
	if (getNet().isServer())
	{
		...
		CBlob@ turret = server_CreateBlob("mlrsturret");	
