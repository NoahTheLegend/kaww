...
void onInit(CBlob@ this)
{
	...
	{ CSpriteLayer@ w = Vehicle_addWoodenWheel(this, v, 0, Vec2f(20.0f, 4.0f)); if (w !is null) w.SetRelativeZ(10.0f);  w.ScaleBy(Vec2f(0.75f, 0.75f));}
	{ CSpriteLayer@ w = Vehicle_addWoodenWheel(this, v, 0, Vec2f(14.0f, 4.0f)); if (w !is null) w.SetRelativeZ(10.0f);  w.ScaleBy(Vec2f(0.75f, 0.75f));}
	{ CSpriteLayer@ w = Vehicle_addWoodenWheel(this, v, 0, Vec2f(8.0f, 4.0f)); if (w !is null) w.SetRelativeZ(10.0f);  w.ScaleBy(Vec2f(0.75f, 0.75f));}
	{ CSpriteLayer@ w = Vehicle_addWoodenWheel(this, v, 0, Vec2f(2.0f, 4.0f)); if (w !is null) w.SetRelativeZ(10.0f);   w.ScaleBy(Vec2f(0.75f, 0.75f));}
	{ CSpriteLayer@ w = Vehicle_addWoodenWheel(this, v, 0, Vec2f(-4.0f, 4.0f)); if (w !is null) w.SetRelativeZ(10.0f);  w.ScaleBy(Vec2f(0.75f, 0.75f));}
	{ CSpriteLayer@ w = Vehicle_addWoodenWheel(this, v, 0, Vec2f(-10.0f, 4.0f)); if (w !is null) w.SetRelativeZ(10.0f); w.ScaleBy(Vec2f(0.75f, 0.75f));}
	{ CSpriteLayer@ w = Vehicle_addWoodenWheel(this, v, 0, Vec2f(-16.0f, 4.0f)); if (w !is null) w.SetRelativeZ(10.0f); w.ScaleBy(Vec2f(0.75f, 0.75f));}
	{ CSpriteLayer@ w = Vehicle_addWoodenWheel(this, v, 0, Vec2f(-22.0f, 4.0f)); if (w !is null) w.SetRelativeZ(10.0f); w.ScaleBy(Vec2f(0.75f, 0.75f));}
	...
	if (tracks !is null)
	{
		...
		tracks.SetOffset(Vec2f(5.0f, -7.0f));
	}
	...
	if (getNet().isServer())
	{
...

		{
			...
			if (soundmanager !is null)
			{
				...
				soundmanager.set_f32("custom_pitch", 1.275f);
				soundmanager.Init();
