...
void ClientFire(CBlob@ this, const s8 charge_time)
{
	if (canSend(this) && this.get_u32("no_reload") < getGameTime())
	{
		...
		ShootBullet(this, this.getPosition() - Vec2f(0,1), this.getAimPos() + Vec2f(-(2 + this.get_u8("inaccuracy")) + (XORRandom(24 + this.get_u8("inaccuracy"))-(16+this.get_u8("inaccuracy")/2))*targetFactor, -(2 + this.get_u8("inaccuracy")) + XORRandom(24 + this.get_u8("inaccuracy"))-(16+this.get_u8("inaccuracy")/2))*targetFactor, 17.59f * bulletvelocity);
