...
{
	ensureCorrectRunnerTexture(this, "antitank", "AntiTankMale");
...
void onTick(CSprite@ this)
{
	...
	else if (showgun)
	{
		...
		else if ((blob.isOnGround() && (left || right)) ||
	...
	if (frontarm !is null)
	{
		...
		{
			Animation@ anim = frontarm.getAnimation("fired");
			if (anim !is null) frontarm.SetAnimation(anim);
		}
	}
}
