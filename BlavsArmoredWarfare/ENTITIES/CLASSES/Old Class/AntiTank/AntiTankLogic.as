...
void ManageGun(CBlob@ this, ArcherInfo@ archer, RunnerMoveVars@ moveVars)
{
	...
	if (this.hasTag("attacking") && getGameTime() == this.get_u32("end_stabbing")-10)
	{
		f32 attackarc = 70.0f;
			...
			charge_time--;
				...
				if (this.getPlayer() !is null)
				{
					...
					if (sprint)
					{
						...
						this.Tag("sprinting");
						moveVars.walkFactor *= this.getPlayer().hasTag("Max Speed") ? 1.075f : 1.05f;
					...
					else
					{
						...
						moveVars.walkFactor *= this.getPlayer().hasTag("Max Speed") ? 0.95f : 0.8f;
