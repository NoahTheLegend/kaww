	...
	void Render()
	{
		...
		for (uint message_step = 0; message_step < count; ++message_step)
		{
			...
			if (message.attackerteam != -1)
			{
				...
				ul.Set(dim.x, (message_step + yOffset + assists) * 28);
			...
			if (message.helperteam != -1)
			{
				...
				ul.Set(dim.x, (message_step + yOffset + assists + 1) * 28);
				col = getTeamColor(message.attackerteam);
			...
			if (hitterIcon != "")
			{
				...
				ul.Set(dim.x, ((message_step + yOffset + assists) * 28) - 8);
			...
			if (message.victimteam != -1)
			{
				...
				ul.Set(dim.x + victim_tag_size.x, (message_step + yOffset + assists) * 28);
