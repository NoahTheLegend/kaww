...
// Cloud vars
const Vec2f MOVE_VEL = Vec2f(0.1,0); // Base speed
const f32 PARRALEX_EFFECT = 0.05f; // Base effect, each cloud will have a custom one based on this
const u16 CLOUD_COOLDOWN = 300; //400
const u16 PADDING = 500;
...
class Clouds
{
	...
	void SendToRenderer() // Checks that our cloud is on screen then passes it to render
	{
		...
		Vec2f botRight = topLeft + Vec2f(200, 200)*(ZLevel/10.0f); // /20
